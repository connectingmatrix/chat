...
- Path: `packages/apps/chat/src/services/chat/slash`
...
- Functions (all):
  - `parseSlashCommand` (L29-L29, function)
  - `stripCommandPrefix` (L40-L40, function)
- Exports:
  - `parseSlashCommand` (L29)
  - `stripCommandPrefix` (L40)
- Key snippets and use-case mapping:
  - `L29-L29`: Implements `parseSlashCommand` for this module use case.
  - `L40-L40`: Implements `stripCommandPrefix` for this module use case.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `idAt` (L196-L196, arrow)
  - `promptAfter` (L197-L197, arrow)
  - `executeTool` (L199-L199, function)
  - `createSlashHints` (L203-L203, function)
  - `executeSlashCommand` (L227-L227, function)
- Exports:
  - `createSlashHints` (L203)
  - `executeSlashCommand` (L227)
- Key snippets and use-case mapping:
  - `L196-L196`: Implements `idAt` for this module use case.
  - `L197-L197`: Implements `promptAfter` for this module use case.
  - `L199-L199`: Implements `executeTool` for this module use case.
  - `L203-L203`: Implements `createSlashHints` for this module use case.
  - `L227-L227`: Implements `executeSlashCommand` for this module use case.
