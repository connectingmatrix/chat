...
- Path: `packages/apps/chat/src/services/chat/telemetry`
...
- Functions (all):
  - `createChatTelemetry` (L34-L34, arrow)
- Exports:
  - `createChatTelemetry` (L34)
- Key snippets and use-case mapping:
  - `L34-L34`: Implements `createChatTelemetry` for this module use case.
