...
- Path: `packages/apps/chat/src/services/chat/actions/write`
...
- Functions (all):
  - `ensureWorkflow` (L12-L12, function)
  - `publicWorkflowRow` (L21-L21, function)
  - `runUpdateWorkflowFromCypher` (L26-L26, function)
- Exports:
  - `runUpdateWorkflowFromCypher` (L26)
- Key snippets and use-case mapping:
  - `L12-L12`: Implements `ensureWorkflow` for this module use case.
  - `L21-L21`: Implements `publicWorkflowRow` for this module use case.
  - `L26-L26`: Implements `runUpdateWorkflowFromCypher` for this module use case.
