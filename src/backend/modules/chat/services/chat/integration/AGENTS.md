...
- Path: `packages/apps/chat/src/services/chat/integration`
...
- Functions (all):
  - `resolveSelectedAgentId` (L13-L13, function)
  - `shouldUseSavedAgent` (L24-L24, function)
  - `executeSelectedAgentForChat` (L28-L28, function)
- Exports:
  - `resolveSelectedAgentId` (L13)
  - `shouldUseSavedAgent` (L24)
  - `executeSelectedAgentForChat` (L28)
- Key snippets and use-case mapping:
  - `L13-L13`: Implements `resolveSelectedAgentId` for this module use case.
  - `L24-L24`: Implements `shouldUseSavedAgent` for this module use case.
  - `L28-L28`: Implements `executeSelectedAgentForChat` for this module use case.
