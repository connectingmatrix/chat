...
- Path: `packages/apps/chat/src/services/chat/workflow/write`
...
- Functions (all):
  - `workflowEventDetails` (L131-L131, arrow)
  - `realtimeBinding` (L174-L174, arrow)
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L131-L131`: Implements `workflowEventDetails` for this module use case.
  - `L174-L174`: Implements `realtimeBinding` for this module use case.
