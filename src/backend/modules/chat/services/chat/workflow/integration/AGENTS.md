...
- Path: `packages/apps/chat/src/services/chat/workflow/integration`
...
- Functions (all):
  - `readContext` (L19-L19, arrow)
  - `notify` (L34-L34, arrow)
  - `forwardWorkflowQueueEventToChatDebug` (L123-L123, arrow)
- Exports:
  - `forwardWorkflowQueueEventToChatDebug` (L123)
- Key snippets and use-case mapping:
  - `L19-L19`: Implements `readContext` for this module use case.
  - `L34-L34`: Implements `notify` for this module use case.
  - `L123-L123`: Implements `forwardWorkflowQueueEventToChatDebug` for this module use case.
