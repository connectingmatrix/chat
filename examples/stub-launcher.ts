...
export function createConnectingmatrixChatStubLauncher(context: RequestContext = {}): PackageLauncherPanel {
  return {
    ...
    actions: [
      { name: 'createChat', label: 'createChat', method: 'LOCAL' as const, description: 'Run createChat demo action' },
      { name: 'queryChat', label: 'queryChat', method: 'LOCAL' as const, description: 'Run queryChat demo action' },
      { name: 'attachFile', label: 'attachFile', method: 'LOCAL' as const, description: 'Run attachFile demo action' }
    ],
...
export const Launcher = { open: createConnectingmatrixChatStubLauncher, mode: 'stub' as const };
